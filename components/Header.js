                    ...
                    <Box>
                        <div className='languages flex center' onClick={() => setShowLangsList(!showLangsList)}>
                            ...
                            <div className={ showLangsList ? "list-languages show" : "list-languages"}>
                                <ul>
                                    <li><Link href={asPath} locale="fr"><Image src="/images/langs/fr.png" alt="Lang" width={25} height={25} /> <span style={{ color: "#333", marginLeft: "8px" }}>Français</span></Link></li>
                                    <li><Link href={asPath} locale="en"><Image src="/images/langs/en.png" alt="Lang" width={25} height={25} /> <span style={{ color: "#333", marginLeft: "8px" }}>English</span></Link></li>
                                    <li><Link href={asPath} locale="ar"><Image src="/images/langs/ar.png" alt="Lang" width={25} height={25} /> <span style={{ color: "#333", marginLeft: "8px" }}>العربية</span></Link></li>
                                </ul>
                            </div>
                        </div>
                    </Box>
